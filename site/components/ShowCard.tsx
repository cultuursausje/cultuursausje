    ...
    <div className="relative cursor-pointer">
      ...
      >
        <div className="flip-inner rounded-3xl">
          ...
          {/* Back */}
          <div className="flip-face flip-back bg-white pt-14 px-5 pb-4 flex flex-col border border-line">
            ...
            <button
              ...
              className="self-end mt-3 flex items-center gap-1 text-xs font-medium text-ink-muted hover:text-ink transition-colors"
            >
              Meer
              <ArrowRight size={13} />
            </button>
